...
// Fetch all products for the "Men" collection using a helper function
...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        /* Top hero banner for the men's collection */
        .hero-section {
            height:40vh;
            display:flex;
...
<!-- Hero banner introducing the men's collection -->
<section class="hero-section">
    <h1>Men's Collection</h1>
    <p>Premium quality clothing for the modern man</p>
</section>

<!-- Main section listing all men's products -->
<section class="products-section">
            ...
            <?php while ($product = mysqli_fetch_assoc($products_result)): ?>
                <div class="product-card">
                    <div class="product-image">
                        <!-- Product image with fallback placeholder on load error -->
                    ...
                    <div class="product-info">
                        ...
                        $sizes = [];
                        // Collect non-empty size names into an array
                        ...
                        ?>
                        <?php if (!empty($sizes)): ?>
                            <!-- Display unique available sizes for the product -->
                        ...
                        <!-- Link to detailed product page for the selected product -->
    ...
    <?php else: ?>
        <!-- Fallback text if no men's products exist in the database -->
